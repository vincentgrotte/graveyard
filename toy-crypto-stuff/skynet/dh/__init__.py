...
def calculate_dh_secret(their_public, my_private):
    ...
    # this was the method given in RFC2631
    zz = (their_public ** my_private) % prime
    shared_secret = zz.to_bytes(256, byteorder='big')
    ...
    # format the shared hash a bit while it's here
